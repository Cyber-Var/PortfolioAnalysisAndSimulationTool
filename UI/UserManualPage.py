...
class UserManualPage(QWidget, Page):
    ...
    def show_guide(self):
        if self.is_guide:
            ...
            image_path = os.path.join(self.cwd, "user manual", f"guide_{self.current_index}.png")
            ...
            image_path = os.path.join(self.cwd, "user manual", f"algorithm_{self.current_index}.png")
            pixmap = QPixmap(image_path)

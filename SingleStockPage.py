...
from PyQt5.QtWidgets import QVBoxLayout, QWidget, QHBoxLayout, QLabel, QRadioButton, QComboBox, QPushButton, QTableWidget, QTableWidgetItem, QAbstractItemView, QFrame
...
class SingleStockPage(QWidget, Page):
    """
    Page displaying detailed predictions and graphs for a single chosen stock
    """
    ...
    def __init__(self, main_window, controller, dpi):
        ...
        :param dpi: dpi used for plotting graphs (in PPI)
        """
        super().__init__()
        ...
        # Initialize building widgets variables:
    ...
    def set_parameters(self, ticker, stock_name, one_share_price, num_shares, hold_duration, is_long):
        """
        Setter for the page's information
        :param ticker: chosen stock's ticker
        :param stock_name: chosen stock's name
        :param one_share_price: chosen stock's price of 1 share
        :param num_shares: chosen stock's number of shares selected
    ...
    def clear_layout(self, layout):
        """
        Method that deleted all widgets of a layout
    ...
    def draw_info_and_manipulation_box(self):
        """
        Method for building the top-left part of the page concerned with stock's information
        """
    ...
    def draw_algorithm_results_box(self):
        """
        Method for building the bottom-left part of the page concerned with algorithmic predictions
        """
    ...
    def setDefaultResultsTable(self):
        """
        Method for setting the size of algorithmic results table to default
        """
    ...
    def setMonteResultsTable(self):
        """
        Method for setting the size of algorithmic results table tailored to Monte Carlo predictions
        """
    ...
    def stylize_table(self, table):
        """
        Method for setting the style of a table
        :param table: the table to stylize
        """
    ...
    def draw_graphs_box(self):
        """
        Method for building the top-right part of the page concerned with graphs display
        """
    ...
    def draw_risk_metrics_box(self):
        """
        Method for building the bottom-right part of the page concerned with rick metrics and ESG scores
        """
    ...
    def create_frame(self):
        """
        Method for creating a frame used for labels with multiple styles inside
        """
        frame = QFrame()
    ...
    def create_esg_frame(self):
        """
        Method for creating an ESG frame used for labels with multiple styles inside
        """
        frame = QFrame()
        frame_layout = QVBoxLayout(frame)
        frame_layout.setSpacing(0)
    ...
    def process_category_style(self, category):
        """
        Method that returns icon's style based on category
    ...
    def process_risk_metric_style(self, category):
        """
        Method that returns icon's style based on rick metrics category
        :param category: Low/Normal/High
        :return icon's style
        """
        if category == "Low":
    ...
    def hold_duration_button_toggled(self, checked):
        """
        Method called when a new hold duration is selected by user
    ...
    def graphs_choice_button_toggled(self, checked):
        """
        Method called when a new graph is requested by user
        :param checked: boolean
        """
        if checked:
    ...
    def update_graph(self):
        """
        Method for displaying requested graoh
        """
        try:
            ...
            self.main_window.show_error_window("Error occurred when displaying the graph.",
                                               "Please check your Internet connection.")

    def format_number(self, num):
        """
        Method for rounding the format of a prediction's result
    ...
    def algorithm_changed(self):
        """
        Method called when a new algorithm is requested by user
        """
        self.play_action_sound()
        ...
        if algorithm_entered == "Please select an algorithm":
            ...
            # If Monte Carlo requested, display statistical breakdown:
            ...
            # Otherwise, display predicted profit/loss amount:
            else:
                self.setDefaultResultsTable()
                self.growth_widget.hide()
                self.fall_widget.hide()
...
class CustomComboBox(QComboBox):
    """
    Custom combo box allowing only certain keyboard inputs
    """
